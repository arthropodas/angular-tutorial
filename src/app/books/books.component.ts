...
export class BooksComponent implements OnInit {
  ...
  handleClick(){
    ...
    this.isDisable=true;
    // if(confirm("ok")){
    //   console.log("yuou pressed")
    // }
  }
  handleInput(event:any){
    // alert(`you pressed hiii",${event.target.value}`)
  ...
  addTocart=(event: any)=>{
    console.log("from the parent", event);
